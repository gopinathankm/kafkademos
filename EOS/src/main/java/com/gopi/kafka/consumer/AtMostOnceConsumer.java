 ...
 *  The commit interval passes and Kafka commits the offset, but client did not complete the
 ...
 * Client processed a message and committed to its persistent store. But the Kafka commit interval is NOT
