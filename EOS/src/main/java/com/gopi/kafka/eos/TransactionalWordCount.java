...
import com.gopi.kafka.model.Tuple;
...
public class TransactionalWordCount {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                // records(), Get just the ConsumerRecord for the given topic
                Map<String, Integer> wordCountMap = records.records(new TopicPartition(INPUT_TOPIC, 0))
                        // Collection interface method, stream() to generate a Stream.
            ...
            // Aborts the ongoing transaction in case of any exception.
    ...
    private static KafkaProducer<String, String> createKafkaProducer() {
        ...
        // Needs to be called initTransactions() before any other methods when the transactional.id is set in the configuration.
