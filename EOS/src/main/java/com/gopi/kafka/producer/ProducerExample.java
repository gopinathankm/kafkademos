 ...
 * 19/12/2018
 *
 * A sample Kafka producer client to produce a bunch of messages.
 */
public class ProducerExample {

    public static void main(String[] str) throws InterruptedException, IOException, Exception {
    ...
    private static void sendMessages() throws InterruptedException, IOException, Exception {
    ...
    private static void sendMessages(Producer<String, String> producer) throws Exception{
